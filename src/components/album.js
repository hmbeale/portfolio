                    ...
                    >
                      <div style={getModalStyle()} className={classes.paper}>
                        ...
                        <Typography
                          ...
                          id="simple-modal-description"
                        >
                          I write web applications for fun and for money. Most
                          of my knowledge and experience is on the front end (I
                          enjoy working with React especially), but I can
                          wrangle a little Python and Node as well.
                        </Typography>
